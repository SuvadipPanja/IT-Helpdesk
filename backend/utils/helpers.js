...
// NOTE: validatePasswordStrength() REMOVED — was using stale .env values.
// Use securityService.validatePasswordPolicy() instead (reads live DB settings).
...
/**
 * Format date to configured timezone string
 * @param {Date} date - Date object
 * @returns {string} Formatted date string in configured timezone
 */
const formatDateIST = (date) => {
  const dateUtils = require('./dateUtils');
  return dateUtils.formatDateTimeSync(date);
};
