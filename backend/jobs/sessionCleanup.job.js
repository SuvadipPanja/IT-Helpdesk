// ============================================
// FILE: sessionCleanup.job.js
// LOCATION: backend/jobs/sessionCleanup.job.js
// FULL PATH: D:\Project\it-helpdesk\backend\jobs\sessionCleanup.job.js
// PURPOSE: Remove expired and inactive sessions
// DEVELOPER: Suvadip Panja
// DATE: November 08, 2025 (FIXED)
// ============================================
...
class SessionCleanupJob {
  ...
  start() {
    ...
    logger.info(`🕐 ${this.jobName} scheduled`, { schedule: this.cronExpression });
  ...
  async execute() {
    ...
    try {
      ...
      const sessionTimeoutMinutes = parseInt(settings.session_timeout_minutes) || 480;
      ...
      const deleteOldQuery = `
        ...
        WHERE is_active = 0
          AND DATEDIFF(DAY, login_at, GETDATE()) > 30
      `;
    ...
    try {
      const statsQuery = `
        SELECT 
          ...
          COUNT(DISTINCT user_id) as unique_users,
          AVG(DATEDIFF(MINUTE, login_at, GETDATE())) as avg_age_minutes
        FROM user_sessions
      `;
