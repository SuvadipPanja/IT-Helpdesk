 ...
 * @desc    Get ticket distribution by location
 * @access  Private (Admin/Manager)
 * @query   start_date, end_date (optional)
 */
 ...
 * @desc    Get ticket distribution by process
 * @access  Private (Admin/Manager)
 * @query   start_date, end_date (optional)
 */
router.get('/by-process', getByProcess);

/**
 * @route   GET /api/v1/analytics/bot
 * @desc    Get bot activity summary: sessions, messages, intents
 * @access  Private (Admin/Manager)
 * @query   start_date, end_date (optional)
 */
