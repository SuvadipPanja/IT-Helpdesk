...
// ⭐ Dynamic, DB-configurable rate limiters
const { loginLimiter, twoFactorLimiter, passwordResetLimiter } = require('../middleware/rateLimiter');
 ...
 */
router.post('/verify-2fa-login', twoFactorLimiter, verifyTwoFactorValidator, validateRequest, verifyTwoFactorLogin);
 ...
 */
router.post('/forgot-password', passwordResetLimiter, forgotPasswordValidator, validateRequest, passwordResetController.forgotPassword);
 ...
 * @created January 26, 2026
 */
router.post('/reset-password', passwordResetLimiter, resetPasswordValidator, validateRequest, passwordResetController.resetPassword);
