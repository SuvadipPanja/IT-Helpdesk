// ============================================
// RESET PASSWORD PAGE
// Users create new password using reset token
...
import { Lock, Eye, EyeOff, Check, X, AlertCircle, Loader } from 'lucide-react';
          ...
          <div className="password-requirements">
            ...
            <ul>
              ...
              <li className={/[a-z]/.test(formData.newPassword) && /[A-Z]/.test(formData.newPassword) ? 'met' : ''}>
                <Check size={14} /> Uppercase and lowercase letters
              </li>
