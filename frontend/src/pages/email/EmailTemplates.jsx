...
const EmailTemplates = () => {
  ...
  /** Where merge-tag clicks go: subject line or rich body */
      ...
      <div className="page-container">
        ...
        <div className="filters-section">
          <div className="filters-row">
            ...
            {/* Refresh Button */}
            <RefreshButton onClick={fetchTemplates} loading={loading} label="Refresh" />
          </div>
        </div>
            ...
            <div className="modal-content" onClick={(e) => e.stopPropagation()}>
              ...
              <div className="modal-body">
                ...
                <div className="form-group">
                  ...
                  />
                  <p className="form-hint">Use {'{{variable}}'} for dynamic content. Choose “Subject line” below to insert tags into the subject.</p>
                </div>
                ...
                <div className="insert-target-bar">
                  ...
                  <label className={`insert-target-option ${variableTarget === 'subject' ? 'is-active' : ''}`}>
                    <input
                      type="radio"
                      name="varTarget"
                      checked={variableTarget === 'subject'}
                      onChange={() => setVariableTarget('subject')}
                    />
                    Subject line
                  </label>
                  <label className={`insert-target-option ${variableTarget === 'body' ? 'is-active' : ''}`}>
                    <input
                      type="radio"
                      name="varTarget"
                      checked={variableTarget === 'body'}
                      onChange={() => setVariableTarget('body')}
                    />
                    Email body
                  </label>
                </div>
