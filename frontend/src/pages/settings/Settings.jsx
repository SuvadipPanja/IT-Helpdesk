                ...
                <div className="settings-section-content">
                  <div className="form-group">
                    ...
                    <select
                      ...
                      style={{
                        borderColor: String(settings.sla?.sla_monitoring_enabled?.value) === 'true' ? '#16a34a' : '#dc2626',
                        borderWidth: '2px'
                      }}
                    >
                      <option value="true">Enabled</option>
                  ...
                  <div style={{ 
                    marginTop: '16px', 
                    padding: '14px 18px', 
                    backgroundColor: String(settings.sla?.sla_monitoring_enabled?.value) === 'true' ? '#f0fdf4' : '#fef2f2', 
                    border: '1px solid ' + (String(settings.sla?.sla_monitoring_enabled?.value) === 'true' ? '#86efac' : '#fecaca'), 
                    borderRadius: '8px', 
                    display: 'flex', 
                    gap: '12px', 
                    alignItems: 'flex-start' 
                    ...
                    <AlertTriangle 
                      size={18} 
                      style={{ 
                        color: String(settings.sla?.sla_monitoring_enabled?.value) === 'true' ? '#16a34a' : '#dc2626', 
                        flexShrink: 0, 
                        marginTop: '2px' 
                      }} 
                    />
                    <div>
                      <p style={{ 
                        ...
                        <strong>⚠️ Important:</strong> This controls the background SLA breach detection job. 
              ...
              <div className="settings-section">
                ...
                <div className="settings-section-content">
                  <div className="form-grid">
                    ...
                    {/* ⭐ FIELD 8: Notify on SLA Warning (NEW!) */}
                    <div className="form-group">
                      <label className="form-label">
                        <MessageSquare size={16} />
                      ...
                      <select
                        className="form-select"
                        value={String(settings.sla?.notify_on_sla_warning?.value || 'true')}
                        onChange={(e) => handleSettingChange('sla', 'notify_on_sla_warning', e.target.value)}
                        disabled={String(settings.sla?.sla_enabled?.value) !== 'true'}
                      >
                        <option value="true">Yes</option>
                        <option value="false">No</option>
                    ...
                    {/* ⭐ FIELD 9: Notify on SLA Breach (NEW!) */}
                    <div className="form-group">
                      <label className="form-label">
                        <MessageSquare size={16} />
                      ...
                      <select
                        className="form-select"
                        value={String(settings.sla?.notify_on_sla_breach?.value || 'true')}
                        onChange={(e) => handleSettingChange('sla', 'sla_breach', e.target.value)}
                        disabled={String(settings.sla?.sla_enabled?.value) !== 'true'}
                      >
                        <option value="true">Yes</option>
                        <option value="false">No</option>
                  ...
                  <div style={{ 
                    ...
                    <HelpCircle size={18} style={{ color: '#0369a1', flexShrink: 0, marginTop: '2px' }} />
                    <div>
                      <p style={{ fontSize: '13px', color: '#0369a1', margin: 0, lineHeight: '1.6', fontWeight: '500' }}>
                ...
                <div className="settings-section-content">
                  {loadingBackups ? (
                    <div style={{ textAlign: 'center', padding: '40px' }}>
                      ...
                      <p style={{ marginTop: '16px', color: '#64748b' }}>Loading backups...</p>
                    </div>
                    ...
                    <>
                              ...
                              <tr key={backup.backup_id}>
                                <td>
                                  <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                                    <Database size={16} />
                                    <span style={{ fontWeight: '500' }}>{backup.backup_name || 'N/A'}</span>
                                  </div>
                                </td>
                                <td>
                      ...
                      {backupPagination && backupPagination.totalPages > 1 && (
                        <div className="pagination" style={{ marginTop: '20px' }}>
                          ...
                          <span style={{ margin: '0 16px', color: '#64748b' }}>
