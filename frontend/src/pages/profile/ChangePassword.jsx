      ...
      try {
        ...
        if (response.data.success && response.data.data) {
          ...
          const policy = {
            ...
            expiryDays: parseInt(settings.password_expiry_days) || 0,
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response.data.success) {
        ...
        // Clear the password expired flag if it was set
        if (passwordExpired) {
      ...
      <div className="profile-page">
        ...
        <div className="change-password-container">
          <div className="profile-card" style={{ textAlign: 'center', padding: '3rem' }}>
            ...
            <p style={{ marginTop: '1rem', color: 'var(--pf-text-muted, #6b7280)' }}>
    ...
    <div className="profile-page">
      ...
      {passwordExpired && (
        <div style={{
          ...
          <div>
            <strong style={{ display: 'block', fontSize: '15px', marginBottom: '2px' }}>
              Password Expired — Action Required
            </strong>
            Your password has expired. You must change your password before you can continue using the system.
            All other features are locked until you update your password.
          </div>
        </div>
      )}
        ...
        <div className="profile-card">
          ...
          {passwordPolicy && (
            <div className="password-requirements">
              ...
              <div className="requirement-item requirement-info">
                <Check size={18} className="check-icon" />
                <span>
