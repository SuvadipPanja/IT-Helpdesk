...
import { X, User, Mail, Lock, Phone, Shield, Building, Save, Loader, Check, AlertCircle, MapPin, Briefcase } from 'lucide-react';
...
const CreateUserModal = ({ onClose, onSuccess, roles, departments, locations, processes }) => {
  const toast = useToast();
  const assignableRoles = roles.filter((role) => String(role.role_code || '').toUpperCase() !== PROTECTED_ADMIN_ROLE_CODE);
            ...
            <div className="form-grid">
              ...
              <div className="form-column">
                ...
                <div className="form-group">
                  ...
                  <small className="form-help">Administrator role is reserved for the protected admin account.</small>
                </div>
