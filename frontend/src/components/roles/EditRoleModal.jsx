...
const EditRoleModal = ({ role, onClose, onSuccess }) => {
  const isProtectedAdminRole = String(role.role_code || '').toUpperCase() === PROTECTED_ADMIN_ROLE_CODE;
        ...
        <div className="modal-body">
          {isProtectedAdminRole && (
            <div className="alert alert-info">
              <span>Administrator role is permanently protected. It can be viewed but cannot be edited by any account.</span>
            </div>
          )}

          {role.is_system_role && (
            <div className="alert alert-info">
              <span>{isProtectedAdminRole ? 'This system role is locked.' : 'This is a system role. You can only view and modify permissions.'}</span>
            </div>
          )}
