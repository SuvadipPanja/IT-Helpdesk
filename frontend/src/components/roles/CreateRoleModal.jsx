...
const RESERVED_ADMIN_ROLE_CODE = 'ADMIN';
const RESERVED_ADMIN_ROLE_NAME = 'ADMINISTRATOR';
...
const CreateRoleModal = ({ onClose, onSuccess }) => {
  ...
  const validateForm = () => {
    ...
    } else if (formData.role_code.trim().toUpperCase() === RESERVED_ADMIN_ROLE_CODE) {
      newErrors.role_code = 'ADMIN is a protected system role code and cannot be reused';
    }

    if (formData.role_name.trim().toUpperCase() === RESERVED_ADMIN_ROLE_NAME) {
      newErrors.role_name = 'Administrator is a protected system role name and cannot be reused';
    }
          ...
          <form onSubmit={handleSubmit} className="role-form">
            ...
            <div className="form-group">
              ...
              <small className="form-help">
                Uppercase letters, numbers, hyphens, and underscores only. ADMIN is reserved.
              </small>
            </div>
