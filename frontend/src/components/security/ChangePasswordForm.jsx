// ============================================
// CHANGE PASSWORD FORM COMPONENT (CORRECTED)
// Uses existing settings API - NO HARDCODED VALUES
// ============================================
...
// USES EXISTING API: PUT /api/v1/auth/change-password
// ============================================
...
const ChangePasswordForm = ({ onSuccess, onCancel }) => {
   ...
   * The meter already fetches policy from database
   */
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6">
      ...
      {/* Password Strength Meter - Fetches policy from database */}
